         ...
         <div className="grid grid-cols-3 gap-4 mb-4">
            <div className="flex items-center justify-between h-24 rounded-xl bg-white p-5">
                  ...
                  <div className="bg-[#7BCBD4] p-2 rounded-2xl">
                     <FaHome style={{height: 30, width: 30}}/>
                  </div>
            </div>
            <div className="flex items-center justify-between h-24 rounded-xl bg-white p-5">
                  <div className="flex flex-col text-black w-1/2">
                  ...
                  <div className="bg-[#7BCBD4] p-2 rounded-2xl">
                     <FaRestroom style={{height: 30, width: 30}}/>
                  </div>
            </div>
            <div className="flex items-center justify-between h-24 rounded-xl bg-white p-5">
                  <div className="flex flex-col text-black w-1/2">
                  ...
                  <div className="bg-[#7BCBD4] p-2 rounded-2xl">
                     <FaDoorOpen style={{height: 30, width: 30}}/>
                  </div>
            </div>
            <div className="flex items-center justify-between h-24 rounded-xl bg-white p-5">
                  <div className="flex flex-col text-black w-1/2">
                     <p className="font-bold text-gray-400 text-sm">Pembayaran Terlambat</p>
                     <p className="font-bold text-2xl">5</p>
                  </div>
                  <div className="bg-[#7BCBD4] p-2 rounded-2xl">
                     <FaClock style={{height: 30, width: 30}}/>
                  </div>
            </div>
            <div className="flex items-center justify-between h-24 rounded-xl bg-white p-5">
                  <div className="flex flex-col text-black w-1/2">
            ...
            <div className="flex items-center justify-between h-24 rounded-xl bg-white p-5">
                  <div className="flex flex-col text-black w-1/2">
                     <p className="font-bold text-gray-400 text-sm">Ruangan Tidak Aktif</p>
                     <p className="font-bold text-2xl">5</p>
                  </div>
                  <div className="bg-[#7BCBD4] p-2 rounded-2xl">
                     <FaDoorOpen style={{height: 30, width: 30}}/>
